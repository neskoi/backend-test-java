...
public class TokenService {
	...
	private String generateToken(Long id) {
		...
		return Jwts.builder().setIssuer("API Minha Vaga - Gerenciamento de vagas de estacionamento.")
				.setSubject(String.valueOf(id)).setIssuedAt(today).setExpiration(tokenExpiration)
